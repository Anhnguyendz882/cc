...
// Hàm treo Spotify cho từng lính
...
// ================= BỘ LỌC ÂM THANH APPO MAX VOLUME =================
function createAppoResource(filePath) {
    const ffmpeg = spawn('ffmpeg', [
        '-i', filePath,
        '-filter:a', 
        'volume=65dB, acompressor=threshold=-10dB:ratio=20:attack=5:release=50, bass=g=25:f=110, alimiter=limit=0.9:level=1',
